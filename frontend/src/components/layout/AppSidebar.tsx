...
const navItems = [
  { to: "/", icon: LayoutDashboard, label: "Dashboard" },
  {
    ...
    subItems: [
      { to: "/participants", label: "View Participants" },
      { to: "/participants/add", label: "Add Participant" },
    ],
  },
  {
    label: "Colleges",
    ...
    basePath: "/colleges",
    subItems: [
      { to: "/colleges", label: "View Colleges" },
      { to: "/colleges/add", label: "Add College" },
    ],
  },
  {
    label: "Events",
  ...
  { to: "/results", icon: Medal, label: "Results" },
];
